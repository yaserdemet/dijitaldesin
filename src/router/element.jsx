...
export const SssPage = Loadable(lazy(() => import("../pages/Sss.jsx")));
export const BlogPage = Loadable(lazy(() => import("../pages/Blog.jsx")));
export const BlogDetailPage = Loadable(lazy(() => import("../pages/BlogDetail.jsx")));
